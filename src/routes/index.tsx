  ...
  return (
    <section id="treatments" className="py-24 sm:py-32 bg-white/60 relative">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="treatments-scroll mt-8 flex gap-5 overflow-x-auto pb-4 pr-4 snap-x snap-mandatory">
          {TREATMENTS.map(({ icon: Icon, title, desc }, i) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="group relative min-w-[18rem] sm:min-w-[20rem] lg:min-w-[21rem] max-w-[21rem] shrink-0 snap-start rounded-3xl bg-[var(--ivory)] p-6 ring-1 ring-black/[0.05] shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-elev)] transition-all overflow-hidden"
            >
