      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-[var(--saffron)]/25 bg-[var(--saffron-light)]/60 p-4 flex flex-col justify-between shadow-sm">
          <div>
            ...
            <div className="type-h1 mt-3 flex items-baseline gap-1 font-black text-[var(--ink)]">
                  ...
                  <tr key={p.id} className="hover:bg-[var(--ivory)]/40 transition-colors">
                    ...
                    <td className="px-4 py-3 text-xs font-medium text-[var(--ink-soft)]">
                      <div className="flex items-center gap-1.5">
                        <PhoneAppIcon className="h-3 w-3" />
                        {p.patientPhone}
                      </div>
                    </td>
        ...
        {isFormOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <motion.div
              ...
              className="site-card w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl relative"
            >
