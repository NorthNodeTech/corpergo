...
import type { Category, Clinic } from "@/lib/patient/clinic-data";
...
export function instantWalkInAppointments(
  ...
  appointments: import("@/lib/physio/physio-data").PhysioAppointment[],
  ...
  return requests
    ...
    .filter((appt): appt is import("@/lib/physio/physio-data").PhysioAppointment => Boolean(appt))
